    ...
    render() {
        return (
            <div className="page-content">
                <h1 className="page-title">{`Examen ${this.props.examType}: ${this.props.numQuestions} preguntas`}</h1>
                <Switch>
                    <Route exact path={this.props.match.path} component={ExamBegin} />
                    <Route exact path={this.props.match.path + '/en_proceso'} render={() => <ExamInProgress numQuestions={this.props.numQuestions} goToResultsPage={this.goToResultsPage}/>} />
